---
page_title: "zstack_virtual_router_offering Resource - terraform-provider-zstack"
subcategory: ""
description: |-
...
# zstack_virtual_router_offering (Resource)
...
```shell
terraform import zstack_virtual_router_offering.example <uuid>
```
