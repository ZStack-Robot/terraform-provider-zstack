---
page_title: "zstack_instance_offering Resource - terraform-provider-zstack"
subcategory: ""
description: |-
...
# zstack_instance_offering (Resource)
...
```shell
terraform import zstack_instance_offering.example <uuid>
```
