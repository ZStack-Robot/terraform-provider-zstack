		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("data.zstack_virtual_router_offers.test", tfjsonpath.New("virtual_router_offers").AtSliceIndex(0).AtMapKey("cpu_num"), knownvalue.Int32Exact(int32(envInt(vro, "cpu_num")))),
					statecheck.ExpectKnownValue("data.zstack_virtual_router_offers.test", tfjsonpath.New("virtual_router_offers").AtSliceIndex(0).AtMapKey("cpu_speed"), knownvalue.Int32Exact(0)),
					...
					statecheck.ExpectKnownValue("data.zstack_virtual_router_offers.test", tfjsonpath.New("virtual_router_offers").AtSliceIndex(0).AtMapKey("is_default"), knownvalue.Bool(envBool(vro, "is_default"))),
					...
					statecheck.ExpectKnownValue("data.zstack_virtual_router_offers.test", tfjsonpath.New("virtual_router_offers").AtSliceIndex(0).AtMapKey("memory_size"), knownvalue.Int64Exact(int64(envInt(vro, "memory_size")))),
					...
					statecheck.ExpectKnownValue("data.zstack_virtual_router_offers.test", tfjsonpath.New("virtual_router_offers").AtSliceIndex(0).AtMapKey("sort_key"), knownvalue.Int32Exact(int32(envInt(vro, "sort_key")))),
