		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("data.zstack_disk_offers.test", tfjsonpath.New("disk_offers").AtSliceIndex(0).AtMapKey("disk_size"), knownvalue.Int64Exact(int64(envInt(do, "disk_size")))),
					statecheck.ExpectKnownValue("data.zstack_disk_offers.test", tfjsonpath.New("disk_offers").AtSliceIndex(0).AtMapKey("sort_key"), knownvalue.Int32Exact(int32(envInt(do, "sort_key")))),
