		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("data.zstack_instance_offers.test", tfjsonpath.New("instance_offers").AtSliceIndex(0).AtMapKey("cpu_num"), knownvalue.Int32Exact(int32(envInt(io, "cpu_num")))),
					statecheck.ExpectKnownValue("data.zstack_instance_offers.test", tfjsonpath.New("instance_offers").AtSliceIndex(0).AtMapKey("memory_size"), knownvalue.Int64Exact(int64(envInt(io, "memory_size")))),
					statecheck.ExpectKnownValue("data.zstack_instance_offers.test", tfjsonpath.New("instance_offers").AtSliceIndex(0).AtMapKey("sort_key"), knownvalue.Int32Exact(int32(envInt(io, "sort_key")))),
