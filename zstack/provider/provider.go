...
func (p *ZStackProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		ZStackEipDataSource,
		ZStackReservedIpDataSource,
		ZStackSubnetIpRangeDataSource,
...
func (p *ZStackProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		VpcFirewallResource,
		VRouterRouteTableResource,
		VRouterRouteEntryResource,
		CephPrimaryStorageResource,
		CephBackupStorageResource,
		ImageStoreBackupStorageResource,
		IAM2VirtualIDResource,
		AccessKeyResource,
		GlobalConfigResource,
		VpcHaGroupResource,
		CertificateResource,
		LBServerGroupResource,
		AccessControlListResource,
		VolumeBackupResource,
		CephPoolResource,
		AlarmResource,
		SNSTopicResource,
		SNSEmailEndpointResource,
		SNSHttpEndpointResource,
		UserResource,
		RoleResource,
		PolicyResource,
		IAM2OrganizationResource,
		SchedulerJobResource,
		SchedulerTriggerResource,
		VmCdRomResource,
		L2VxlanNetworkResource,
		VipQosResource,
		VpcSharedQosResource,
		PolicyRouteRuleSetResource,
		PolicyRouteRuleResource,
		CdpPolicyResource,
		CdpTaskResource,
		LdapServerResource,
		MonitorTemplateResource,
		MonitorGroupResource,
		WebhookResource,
		LogServerResource,
		FlowMeterResource,
		FlowCollectorResource,
		PortMirrorResource,
		...
		SnmpAgentResource,
		// P3 Resources
		BaremetalChassisResource,
		BaremetalInstanceResource,
		BaremetalPxeServerResource,
		VCenterResource,
		PciDeviceOfferingResource,
		JitSecurityMachineResource,
		SanSecSecurityMachineResource,
		InfoSecSecurityMachineResource,
		FiSecSecurityMachineResource,
		FlkSecSecurityMachineResource,
		IscsiServerResource,
		NvmeServerResource,
		ContainerManagementEndpointResource,
		AliyunProxyVpcResource,
		AliyunNasAccessGroupResource,
		AliyunProxyVSwitchResource,
		DirectoryResource,
		V2VConversionHostResource,
		EmailMediaResource,
